  ...
  return (
    <div className="flex flex-col gap-[32px] px-[4%] py-4 bg-white">
      ...
      <div className="md:gap-[27.48px] gap-[10px] flex flex-row p-[7.63px]">
        <div className="flex flex-col w-1/3  gap-[20.19px]">
          <Image alt="" src={photo} className="w-full" />
          <div className="flex flex-col gap-[10.1px]">
            <div className="flex flex-col gap-[4.75px]">
              <p className="text-[#151716] font-[700] md:text-[14.25px] text-[8px] leading-[19.01px]">
            ...
            <p className="font-[400] md:text-[9.5px] text-[5px] leading-[11.88px] text-[#000000] text-justify">
