...
const ChangePasswordModal = ({ visible, onClose, handleSubmit }: any) => {
  return (
    <div
    ...
    >
      ...
      <div className="bg-white md:w-1/3 w-[95%] py-[14.83px] px-[18.53px] rounded-[4px] gap-[33.36px] z-10 flex flex-col">
        ...
        <div className="bg-[#EDEFFF] mt-4 p-[16px] rounded-[8px] justify-between flex flex-col gap-[18.53px] ">
          ...
          <p className="font-[500]  text-[14.83px] leading-[22.24px] text-[#2E2A39] w-full  text-center">
            You will be Logged out and you will reconfirm your email, click
            Proceed to continue
          </p>
        </div>
        <button
