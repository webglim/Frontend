    ...
    <div className="flex flex-col  px-[4%] py-4 bg-white gap-[32px]">
      ...
      <div className="py-4 flex flex-col gap-[32px]">
        ...
        <div className="flex md:flex-row flex-col p-[12.05px] md:gap-[28.93px] gap-[16px]">
          <div className="md:w-1/3 w-full rounded-[18.52px] p-[24.69px] gap-[12.35px] bg-[#C3DAFF]">
            ...
            <p className="text-[#00000099] font-[500] text-[16px] leading-[20.16px]">
              innovative platform with expert insights. Michael and David
              generate profits, while Emma enjoys secure investments tailored to
              her needs.
            </p>
          </div>
          <div className="md:w-1/3 w-full rounded-[18.52px] p-[24.69px] gap-[12.35px] bg-[#C3DAFF]">
            ...
            <p className="text-[#00000099] font-[500] text-[16px] leading-[20.16px]">
              I've been using this platform for over a year now, and I can
              confidently say it's been a game-changer for my investment
              strategy. with the guidance and support from WGL, I've seen
              significant growth in my portfolio.
            </p>
          </div>
          <div className="md:w-1/3 w-full rounded-[18.52px] p-[24.69px] gap-[12.35px] bg-[#C3DAFF]">
            <div className="flex flex-col gap-[6.17px]">
            ...
            <p className="text-[#00000099] font-[500] text-[16px] leading-[20.16px]">
              As a seasoned crypto investor, in the predominantly male-dominated
              world of cryptocurrency investing, finding a platform that not
              only welcomes diversity but also provides top-notch services is
              crucial.
            </p>
          </div>
        </div>
      ...
      <div className="py-4 flex flex-col gap-[32px]">
        ...
        <div className="flex md:flex-row flex-col md:gap-[58px] gap-[24px]">
          <div className="flex flex-col md:w-1/3 w-full rounded-[10px]  shadow-md bg-white hover:bg-[#FBAD00]">
            ...
            <div className="flex flex-col gap-[24px] items-center mt-6">
              <div className="flex flex-col gap-[32px]">
                <p className="text-[#FBAD00] hover:text-white font-[600] text-[32px] leading-[43.58px]">
                  From /€1,000
                </p>
                <div className="flex flex-col gap-[8px]">
                  <div className="flex flex-row items-center gap-[16px]">
                    <Image src={good} alt="" />
                    <p className="text-[#000000B2] hover:text-white font-[400] text-[15px] leading-[20.43px]">
                      Duration 1 Month
                    </p>
                  </div>
                  <div className="flex flex-row items-center gap-[16px]">
